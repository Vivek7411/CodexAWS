      ...
      <CardContent>
        ...
        <div className="expertise-tags">
          {expertise.map((tag, index) => (
            <span
              className="bg-green-500 text-white px-2 py-1 rounded-full text-xs m-1 inline-block"
              key={index}
            >
              {tag}
            </span>
        ...
        <div className="social-icons flex justify-center mt-4">
          <a
            ...
            className="mx-2 text-gray-400 text-xl hover:text-green-500"
          >
            <SiGithub />
          </a>
          <a
      ...
      <div className="container mx-auto p-5">
        ...
        >
          ...
          <p className="text-lg text-gray-400">
            The talented individuals behind Codex
          </p>
        </motion.div>
